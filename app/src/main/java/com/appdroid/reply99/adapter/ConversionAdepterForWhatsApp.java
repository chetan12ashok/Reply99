...
public class ConversionAdepterForWhatsApp extends RecyclerView.Adapter<ConversionAdepterForWhatsApp.ViewHolder> {

    List<ConversionHolder> list;
    Context context;
    long todayTime;
    public ConversionAdepterForWhatsApp(List<ConversionHolder> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ConversionAdepterForWhatsApp.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.message.setText(conversionHolder.getWhatsAppMassage());
        holder.loadProfilePic(conversionHolder.getCallerName());

        Log.d("onBindViewHolder", "onBindViewHolder: "+conversionHolder.getImageOrVideoFlag());
        ...
        holder.imageSelected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (conversionHolder.getImageOrVideoFlag().equals("video")){
                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    intent.setDataAndType(Uri.parse(conversionHolder.getImageForWhatsApp()),"video/*");
...
*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView options,imageSelected,playBtn;
