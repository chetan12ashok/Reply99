...
public class WhatsappFragment extends Fragment {
    ...
    WhatsAppMassagesAdepter massagesAdepter;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        productViewModel.getWhatsAppMassagesOnly(true).observe(getViewLifecycleOwner(), new Observer<List<MassageHolder>>() {
            @Override
        ...
        massagesAdepter = new WhatsAppMassagesAdepter(list,getContext());
        getWhatsAppMassages();
